...
scriptedtext = {"Lee Knight drops in!","[func:SetFaceSprite,Players.Pichu.Disappointed][voice:v_ralsei]Guess I've got a Sebastian to babysit...Okay, let me explain how to not die.","[func:SetFaceSprite,Players.Pichu.Normal][voice:v_ralsei]Blue bullets won't hurt you if you stand still.","[func:SetFaceSprite,Players.Pichu.Normal][voice:v_ralsei]Orange bullets won't hurt you if you keep moving."}
scripteddialogue = {
...
if turn < 5 then
	encountertext = scriptedtext[turn]
end
...
possible_attacks = { "lee_shoveldrop","lee_digslash","lee_digslash_blue","lee_digslash_orange","lee_dice" }
nextwaves = { "lee_dice" }
...
function EnemyDialogueEnding()
    ...
    if turn < 6 then
    	nextwaves = { possible_attacks[turn] }
    	turn = turn + 1
    else
