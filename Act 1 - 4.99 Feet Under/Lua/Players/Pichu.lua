...
abilities = { "Argue", "Salt the Wound" }    -- Abilities of the Player. If the Player has "Act", he won't be able to use spells!
...
AddSpell("Argue", "Spare TIRED foe", 16, "Enemy")
AddSpell("Salt the Wound", "Heals (somehow)", 32, "Player")
...
function HandleCustomSpell(target, spell)
    ...
    elseif spell == "Salt the Wound" then
        target.Heal(mag * 5)
    end
