...
if GetAlMightyGlobal("15clear") ~= 1 then
...
players = {"Monika"} -- The party. Currently only the first one is used. Party support soon, maybe?
...
maps = {"grassland1","grassland2","hug1","hug2","credits"} -- The maps to load! Leave out the .lua extension.
