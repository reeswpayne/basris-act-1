...
if GetAlMightyGlobal("12clear") ~= 1 then
...
players = {"Sebas"} -- The party. Currently only the first one is used. Party support soon, maybe?
...
maps = {"lab4fake","lab4fake2","lab4fake3"} -- The maps to load! Leave out the .lua extension.
