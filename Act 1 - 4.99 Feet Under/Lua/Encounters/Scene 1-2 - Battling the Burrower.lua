...
if GetAlMightyGlobal("11clear") ~= 1 then
...
players = {"Seba"} -- The party. Currently only the first one is used. Party support soon, maybe?
...
maps = {"cutscene_haircut","lab3fake","lab4","lab4lee"} -- The maps to load! Leave out the .lua extension.
