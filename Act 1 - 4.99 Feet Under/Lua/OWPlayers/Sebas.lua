function main()
    local self
    self = { }
    self.name = "Seb" -- The player name. Used for the bottom bar gui.
    self.folder = "Sebas" -- The folder the sprites are in
    self.x = 340 -- The position you want the player to start at.
    self.y = 160 -- The position you want the player to start at.
    self.namesprite = "face"
    self.speed = 2
    self.hitboxwidth = 30
    self.hitboxheight = 22
    self.size = {2,2}
    Player.SetMaxHPShift(110,1.7,true,true) -- set kris' max hp to 90
    Player.hp = 110
    self.color = { 0, 1, 1 }
    self.animations = {
        IdleLeft  =  {  { 0          }, 0  ,{19,38} },
