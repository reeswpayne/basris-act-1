function main()
    ...
    self.folder = "Seb" -- The folder the sprites are in
    self.x = 320 -- The position you want the player to start at.
    self.y = 240 -- The position you want the player to start at.
