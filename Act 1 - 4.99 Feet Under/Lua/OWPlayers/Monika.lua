function main()
    local self
    self = { }
    self.name = "Monika" -- The player name. Used for the bottom bar gui.
    self.folder = "Monika" -- The folder the sprites are in
    self.x = 300 -- The position you want the player to start at.
    self.y = 250 -- The position you want the player to start at.
